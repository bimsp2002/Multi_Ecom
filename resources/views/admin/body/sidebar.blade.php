<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                <li> <a href=""><i class="bx bx-right-arrow-alt"></i>All
                        SubCategory</a>
                </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href=""><i class="bx bx-right-arrow-alt"></i>Inactive
                        Vendor</a>
                </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href=""><i class="bx bx-right-arrow-alt"></i>Pending
                        Order</a>
                </li>
        ...
        <li>
            ...
            <ul>
                ...
                <li> <a href=""><i class="bx bx-right-arrow-alt"></i>Order By
                        User</a>
                </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href=""><i class="bx bx-right-arrow-alt"></i>All Blog
                        Categroy</a>
                </li>
        ...
        <li>
            ...
            <ul>
                ...
                <li> <a href=""><i class="bx bx-right-arrow-alt"></i>Publish
                        Review</a>
                </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href=""><i class="bx bx-right-arrow-alt"></i>Product
                        Stock</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul>
                ...
                <li> <a href=""><i class="bx bx-right-arrow-alt"></i>Roles in
                        Permission</a>
                </li>

                <li> <a href=""><i class="bx bx-right-arrow-alt"></i>All Roles
                        in Permission</a>
                </li>
