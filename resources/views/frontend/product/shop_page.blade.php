                ...
                <form method="post" action="{{ route('shop.filter') }}">
                    ...
                    <div class="price-filter">
                        <div class="price-filter-inner">
                            ...
                            <input type="text" id="amount" value="Rs 0 - RS 10000" readonly="">
                        ...
                        <div class="content pt-10">
                            ...
                            @else
                                <p class="price mb-0 mt-5">Rs.
                                    {{ $product->selling_price - $product->discount_price }}</p>
                            @endif
...
<script type="text/javascript">
    $(document).ready(function() {
        if ($('#slider-range').length > 0) {
            const max_price = parseInt($('#slider-range').data('max'), 10);
            const min_price = parseInt($('#slider-range').data('min'), 10);

            // Set default price range to the full range
            $("#slider-range").slider({
                range: true,
                min: min_price,
                max: max_price,
                ...
                slide: function(event, ui) {
                    // Update the displayed range and hidden input field as the slider changes
                    $("#amount").val('Rs ' + ui.values[0] + ' - Rs ' + ui.values[1]);
                    $("#price_range").val(ui.values[0] + '-' + ui.values[1]);
                }
            });

            // Set the initial displayed amount and price_range input value
            $("#amount").val('Rs ' + min_price + ' - Rs ' + max_price);
